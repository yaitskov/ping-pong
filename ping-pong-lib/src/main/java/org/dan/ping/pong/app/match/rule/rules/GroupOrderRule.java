...
import org.dan.ping.pong.app.match.rule.rules.tennis.atp.AtpDIIHighestPercentWonSetsRule;
...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = AtpDIIHighestPercentWonSetsRule.class, name = "AtpDII"),
