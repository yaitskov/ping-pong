...
import static org.dan.ping.pong.app.group.GroupRules.PING_PONG_BALANCE_BASED_ORDER_RULES;
...
public class GroupRulesConst {
    ...
    public static final GroupRules G8Q2_M = G8Q2.withOrderRules(PING_PONG_BALANCE_BASED_ORDER_RULES);
