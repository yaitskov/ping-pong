...
@ContextConfiguration(classes = {WonSetsRuleService.class, SportCtx.class})
public class WonSetsRuleServiceTest {
    @Inject
    private WonSetsRuleService sut;
        ...
        assertThat(
                sut.score(MATCHES_UIDS_2_3_4_S, UIDS_2_3_4, null,
                        GroupRuleParams.builder()
                                ...
                                .build())
                        .get().collect(toList()),
                is(asList(ofIntD(UID3, 4, WonSets),
                        ofIntD(UID4, 2, WonSets),
                        ofIntD(UID2, 0, WonSets))));
    }
}
