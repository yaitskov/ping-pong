...
import static org.dan.ping.pong.app.server.bid.BidState.Want;
import static org.dan.ping.pong.app.server.bid.BidState.Win2;
import static org.dan.ping.pong.app.server.place.PlaceMemState.PID;
import static org.dan.ping.pong.app.server.table.TableService.STATE;
import static org.dan.ping.pong.app.server.tournament.CumulativeScore.BEST_ORDER;
import static org.dan.ping.pong.app.server.tournament.TournamentState.Announce;
...
import static org.dan.ping.pong.app.server.tournament.TournamentState.Hidden;
...
import org.dan.ping.pong.app.server.castinglots.CastingLotsService;
import org.dan.ping.pong.app.server.castinglots.rank.CastingLotsRule;
import org.dan.ping.pong.app.server.castinglots.rank.ParticipantRankingPolicy;
import org.dan.ping.pong.app.server.category.CategoryDao;
import org.dan.ping.pong.app.server.category.CategoryInfo;
import org.dan.ping.pong.app.server.category.CategoryService;
