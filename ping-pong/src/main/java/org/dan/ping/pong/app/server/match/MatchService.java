...
import static org.dan.ping.pong.app.server.bid.BidService.WIN_STATES;
import static org.dan.ping.pong.app.server.bid.BidState.Expl;
import static org.dan.ping.pong.app.server.bid.BidState.Lost;
import static org.dan.ping.pong.app.server.bid.BidState.Play;
import static org.dan.ping.pong.app.server.bid.BidState.Quit;
import static org.dan.ping.pong.app.server.bid.BidState.Rest;
import static org.dan.ping.pong.app.server.bid.BidState.Wait;
import static org.dan.ping.pong.app.server.bid.BidState.Win1;
import static org.dan.ping.pong.app.server.bid.BidState.Win2;
import static org.dan.ping.pong.app.server.bid.BidState.Win3;
import static org.dan.ping.pong.app.server.match.MatchState.Auto;
import static org.dan.ping.pong.app.server.match.MatchState.Draft;
import static org.dan.ping.pong.app.server.match.MatchState.Game;
import static org.dan.ping.pong.app.server.match.MatchState.Over;
import static org.dan.ping.pong.app.server.match.MatchState.Place;
import static org.dan.ping.pong.app.server.tournament.ParticipantMemState.FILLER_LOSER_UID;
import static org.dan.ping.pong.app.server.tournament.SetScoreResultName.MatchContinues;
...
import static org.dan.ping.pong.app.server.tournament.TournamentState.Replaced;
...
import org.dan.ping.pong.app.server.bid.BidService;
import org.dan.ping.pong.app.server.bid.BidState;
import org.dan.ping.pong.app.server.group.GroupDao;
import org.dan.ping.pong.app.server.group.GroupInfo;
import org.dan.ping.pong.app.server.group.GroupService;
import org.dan.ping.pong.app.server.group.PlayOffMatcherFromGroup;
import org.dan.ping.pong.app.server.place.PlaceMemState;
import org.dan.ping.pong.app.server.place.PlaceService;
...
import org.dan.ping.pong.app.server.tournament.ConfirmSetScore;
