...
import static org.dan.ping.pong.app.server.auth.AuthService.USER_PART_SESSION_LEN;
import static org.dan.ping.pong.app.server.user.UserDao.EMAIL_IS_USED;
import static org.dan.ping.pong.app.server.user.UserResource.USER_INFO_BY_SESSION;
