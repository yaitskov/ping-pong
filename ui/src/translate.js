module.exports = {
    pl: {
        ...
        'Terminate account': 'Usunąć konto',
        'Set an email': 'Ustawić adres',
        'Email': 'Email',
        'email-is-not-set': 'Email nie ustawiony. Email jest potrzebny do logowania z innych urządzeń'
            + ' lub do regeneracji sesji.',
        'follow-set-email-link': 'Zastosuj <a href="{{url}}">linka</a>, żeby ustawić email',
        ...
        'Send Link btn': 'Wysłać linku',
        'email-has-been-sent': 'List został wysłany. Teraz możesz sprawdić skrzynke.',
        'Info': 'Informacja',
        'sign-in-info': 'Tutaj możesz wygenerować nowe sesję dla własnego konta, jeśli'
        ...
        'the match': 'Mecz',
        'the table': 'Stół',
        'the contestant': 'Zawodnik',
        'state-descr-hint': 'Opis możliwych stanów w meczu.',
        'match-type-hint': 'Typ meczu. Gra może być w grupie lub play off.',
        'table-number-hint': 'Number stołu gdzie mecz musi odbyć lub kreska jeśli jeszcze nie wiadomo',
        'opponent-name': 'Twój oponenta w meczu.',
        'match-state-descr-in-row': 'Stan meczu. Zaczynaj grać raz zostanie Game.',
        'match-type-descr-in-row': 'Typ meczu. Gra może być w grupie lub play off.',
        'table-label-descr-row': 'Number stołu gdzie mecz musi odbyć lub kreska jeśli jeszcze nie wiadomo.',
        'No free table': 'Nie ma wolnych stołów',
        'Your opponent in a game.': 'Twój oponenta w meczu.',
        'you-dont-participate-in-tournament': 'Teraz nie uczestniczysz w jakimkolwiek turnieju.'
            + ' <a href="{{url}}">Poszukaj turniej w stanie rekrutacji</a>'
            + ', który Cię odpowiada i zapisz się!',
        'you-participate-in': 'Teraz uczestniczysz w ',
        'you-participate-in-but': 'ale nie ma meczu do zagrania. Zakończyłeś gry w grupie, '
            + ' ale inny uczestnicy jeszcze nie, więc poczekaj na aktulizacje hormonogramu.',
        'tournament': 'turniej',
        'tournaments': 'turnieje',
        'closest-tournament': 'Najbliższy turniej, do którego zapisałeś, to'
            + ' <a href="{{url}}">{{name}}</a>, zaczyna o {{date}}.',
        'latest-tournament': 'Powszedni turniej w którym zagrałeś to <a href="{{url}}">{{name}}</a>.',
        'My matches to be played': 'Moi mecze do zagrania',

        // match state description
        'State name': 'Stan meczu',
        'Description': 'Opis',
        'the-state-game-descr': 'Wszystki wymagania meczu jest spełnione. Znajdź stół jak najszybciej i zacznaj grać.',
    ...
    en: {
        ...
        'email-is-not-set': 'An email is not set. It\'s required to login from other devices'
        ...
        // my match play list
        'congrat-1st-place': 'Congratulations! You are the champion of the'
            + ' tournament <a href="{{url}}">{{name}}</a>. Follow the previous link to see ratings.',
        'congrat-2st-place': 'Congratulations! You won 2rd place in the'
            + ' tournament <a href="{{url}}">{{name}}</a>. Follow the previous link to see ratings.',
        'congrat-3rd-place': 'Congratulations! You won 3rd place in the'
            + ' tournament <a href="{{url}}">{{name}}</a>. Follow the previous link to see ratings.',
        'congrat-lost': 'You\'ve lost the tournament <a href="{{url}}">{{name}}</a>. Follow the previous link to see ratings.',
        'congrat-quit': 'You have resign from further participation in the tournament <a href="{{url}}">{{name}}</a>.',
        'congrat-expelled': 'You have been expelled from the tournament <a href="{{url}}">{{name}}</a>. Next time obey the rules.',
        ...
        'the match': 'Match',
        'the table': 'Table',
        'the contestant': 'Contestant',
        'state-descr-hint': 'Description of possible states in a match.',
        'match-type-hint':  'Match type. It could be a game in a group or play off.',
        'table-number-hint': 'Table number where the match should be held or dash if it\'s not known yet',
        'opponent-name': 'Your opponent in a game.',
        'match-state-descr-in-row': 'Match state. Start playing once it become the Game.',
        'match-type-descr-in-row': 'Match type. It could be a game in a group or play off.',
        'table-label-descr-row': 'Table number where the match should be held or dash if it\'s not known yet.',
        'No free table': 'No free table',
        'Your opponent in a game.': 'Your opponent in a game.',
        'you-dont-participate-in-tournament': 'Right now you don\'t participate in any tournament.'
            + ' <a href="{{url}}">Find a drafting tournament</a>'
            + ' interesting your and enlist!',
        'you-participate-in': 'Right now you participate in',
        'you-participate-in-but': 'but there is no any match to play. You played all'
            + ' group matches and other participants don\'t. So wait for update'
            + ' on you schedule.',
        'tournament': 'tournament',
        'tournaments': 'tournaments',
        'closest-tournament': 'The closest tournament, you have enlisted,'
            + ' is <a href="{{url}}">{{name}}</a>, which begins at {{date}}.',
        'latest-tournament': 'The latest tournament, you\'ve been, is <a href="{{url}}">{{name}}</a> tournament.',
        'My matches to be played': 'My matches to be played',

        // match state description
        'State name': 'State name',
        'Description': 'Description',
        'the-state-game-descr': 'All requirements of a game are satisfified. Find the table and start to play.',
