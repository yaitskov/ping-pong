module.exports = {
    'tournament is complete': '<a href="{{url}}">Tournament</a> is complete.',
    ...
    'tournament-progress-line': 'Matches: {{totalMatches}}, left: {{leftMatches}}, complete: {{leftMatches | percent : totalMatches}}'
};
